...
- [ ] Subscriptions: POST creates subscription + matching INCOME transaction in one Prisma `$transaction`; endDate computed from planType
- [ ] Subscriptions: GET with status/member filters
